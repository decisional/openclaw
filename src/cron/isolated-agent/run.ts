...
function resolveCronToolPolicy(params: {
  ...
  return {
    ...
    // Explicit runner-owned delivery disables direct messaging so announce-mode
    // jobs do not double-send. Wake-up jobs (delivery.mode="none"/"agent") keep
    // the fresh cron session's normal toolset.
